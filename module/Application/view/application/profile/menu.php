...
<div class="col-lg-3">
    <!-- Sidebar Navigation -->
    <?php  $avatar = (!empty($profile->getAvatar())) ? $profile->getAvatar() : 'no-avatar.png';?>
    <img src="<?= $this->basePath('img/avatar/' . $avatar )?>" width="100%" alt="<?= $profile->getFullName()?>" class="mb-2">
    <br>
    <ul class="list-group">
